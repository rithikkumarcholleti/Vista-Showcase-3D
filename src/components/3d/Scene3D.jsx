...
const Model = ({ modelPath }) => {
  ...
  const CarModelFallback = () => {
    return (
      <group>
        ...
        {/* Car windows */}
        <mesh position={[0.25, 0.35, 0]} rotation={[0, 0, 0]}>
          <boxGeometry args={[1.01, 0.25, 0.8]} />
          <meshStandardMaterial color="#222222" metalness={0.9} roughness={0.1} emissive="#222222" emissiveIntensity={0.1} />
        </mesh>
  ...
  try {
    // Try to load the external model with error handler
